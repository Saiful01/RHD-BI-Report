...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.dailyWeather.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.daily-weathers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_temp') ? 'is-invalid' : '' }}" type="number" name="max_temp" id="max_temp" value="{{ old('max_temp', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mini_temp') ? 'is-invalid' : '' }}" type="number" name="mini_temp" id="mini_temp" value="{{ old('mini_temp', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('avg_temp') ? 'is-invalid' : '' }}" type="number" name="avg_temp" id="avg_temp" value="{{ old('avg_temp', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('humidity') ? 'is-invalid' : '' }}" type="number" name="humidity" id="humidity" value="{{ old('humidity', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dry_bulb') ? 'is-invalid' : '' }}" type="number" name="dry_bulb" id="dry_bulb" value="{{ old('dry_bulb', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dew_point') ? 'is-invalid' : '' }}" type="number" name="dew_point" id="dew_point" value="{{ old('dew_point', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_rain_fall') ? 'is-invalid' : '' }}" type="number" name="total_rain_fall" id="total_rain_fall" value="{{ old('total_rain_fall', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_sunshine_hour') ? 'is-invalid' : '' }}" type="number" name="total_sunshine_hour" id="total_sunshine_hour" value="{{ old('total_sunshine_hour', '') }}" step="0.01">
