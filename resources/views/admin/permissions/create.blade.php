            ...
            <div class="form-row">
                <div class="form-col">
                    <div class="fluent-form-group">
                        ...
                        <input class="fluent-input {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', '') }}" required placeholder="e.g., user_access">
                        @if($errors->has('title'))
                ...
                <div class="form-col">
                    <div class="fluent-form-group">
                        ...
                        <input class="fluent-input {{ $errors->has('display_name') ? 'is-invalid' : '' }}" type="text" name="display_name" id="display_name" value="{{ old('display_name', '') }}" required placeholder="e.g., Access Users">
