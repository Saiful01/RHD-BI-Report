    ...
    <div class="fluent-card-body">
        <form method="POST" action="{{ route("admin.roles.update", [$role->id]) }}" enctype="multipart/form-data">
            ...
            <div class="fluent-form-group">
                ...
                <input class="fluent-input {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $role->title) }}" required placeholder="e.g., Admin, Editor, Viewer">
                @if($errors->has('title'))
