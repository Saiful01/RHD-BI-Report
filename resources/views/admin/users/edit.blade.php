            ...
            <div class="form-row">
                <div class="form-col">
                    <div class="fluent-form-group">
                        ...
                        <input class="fluent-input {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $user->name) }}" required placeholder="Enter full name">
                        @if($errors->has('name'))
                ...
                <div class="form-col">
                    <div class="fluent-form-group">
                        ...
                        <input class="fluent-input {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $user->email) }}" required placeholder="Enter email address">
                        @if($errors->has('email'))
                            <div class="fluent-invalid-feedback">
                                {{ $errors->first('email') }}
                            </div>
            ...
            <div class="form-row">
                <div class="form-col">
                    <div class="fluent-form-group">
                        ...
                        <input class="fluent-input {{ $errors->has('password') ? 'is-invalid' : '' }}" type="password" name="password" id="password" placeholder="Leave blank to keep current password">
